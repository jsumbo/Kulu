...
// This is the main widget for the Swahili lesson screen.
...
// This is the state class for the Swahili lesson screen.
class SwahiliScreenState extends State<SwahiliScreen> {
  ...
  void fetchLesson() async {
    try {
      // Get the document from the 'lessons' collection with ID 'lesson1'.
  ...
  // This method builds the UI for the Swahili lesson screen.
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Display the Swahili question.
            Text(
              questionSwahili.isNotEmpty ? questionSwahili : 'Loading question...',
