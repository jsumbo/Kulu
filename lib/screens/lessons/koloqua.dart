...
// This is the main widget for the Koloqua lesson screen.
...
// This is the state class for the Koloqua lesson screen.
class KoloquaScreenState extends State<KoloquaScreen> {
  ...
  void fetchLesson() async {
    try {
      // Get the document from the 'lessons' collection with ID 'lesson2'.
  ...
  // This method builds the UI for the Koloqua lesson screen.
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Koloqua Lesson'),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Display the Koloqua question.
            Text(
              questionKoloqua.isNotEmpty ? questionKoloqua : 'Loading question...',
