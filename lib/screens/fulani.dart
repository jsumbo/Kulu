...
// This is the main widget for the Fulani lesson screen.
...
// This is the state class for the Fulani lesson screen.
class FulaniScreenState extends State<FulaniScreen> {
  ...
  void fetchLesson() async {
    try {
      // Get the document from the 'lessons' collection with ID 'lesson3'.
  ...
  // This method builds the UI for the Fulani lesson screen.
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Display the Fulani question.
            Text(
              questionFulani.isNotEmpty ? questionFulani : 'Loading question...',
