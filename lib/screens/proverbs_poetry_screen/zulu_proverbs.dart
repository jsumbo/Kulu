...
class ZuluProverbsScreen extends StatefulWidget {
  @override
  _ZuluProverbsScreenState createState() => _ZuluProverbsScreenState();
}

class _ZuluProverbsScreenState extends State<ZuluProverbsScreen> {
